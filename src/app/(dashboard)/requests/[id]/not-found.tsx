  ...
  return (
    <div className="max-w-md mx-auto py-16 px-4 text-center space-y-5">
      ...
      <div className="pt-2">
        <Link
          href="/requests"
          className="inline-flex items-center gap-2 px-4 py-2.5 min-h-[44px] rounded-xl text-xs font-semibold text-white bg-violet-600 hover:bg-violet-700 active:bg-violet-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 transition-colors shadow-xs"
        >
