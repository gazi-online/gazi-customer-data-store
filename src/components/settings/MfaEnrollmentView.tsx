          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                Your account is protected. An authenticator app (Google Authenticator, Microsoft Authenticator, Authy, etc.) is configured for sign-in.
              </p>
            </div>
          </div>
      ...
      {viewState === "READY_TO_ENROLL" && (
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5 sm:p-7 shadow-xs space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              When two-step verification is enabled, you will need a 6-digit security code generated by your authenticator app each time you sign in.
            </p>
          </div>
      ...
      {viewState === "SUCCESS" && (
        <div className="bg-white rounded-2xl border border-emerald-200/80 p-6 sm:p-8 shadow-xs space-y-5 text-center">
          ...
          <div className="space-y-1.5 max-w-md mx-auto">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              Your account is now protected with an authenticator app. You can use your app to generate security codes whenever required.
            </p>
          </div>
