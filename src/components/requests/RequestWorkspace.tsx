    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Card 2: Attached Documents (Read-Only) */}
          <section className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 shadow-xs space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-bold uppercase tracking-wider text-slate-500 dark:text-zinc-400 flex items-center gap-2">
                ...
                <span>Attached Documents (Read-Only)</span>
              </h2>
            ...
            {data.documents.length === 0 ? (
              <div className="p-6 rounded-xl bg-slate-50 dark:bg-zinc-800/30 border border-dashed border-slate-200 dark:border-zinc-800 text-center space-y-1">
                ...
                <p className="text-[11px] text-slate-400 dark:text-zinc-500">
                  Document attachment workflows are managed through the documents module.
                </p>
              </div>
            ) : (
              <div className="space-y-2.5">
                {data.documents.map((doc) => (
                  <div
                    key={doc.id}
                    className="p-3.5 rounded-xl bg-slate-50/70 dark:bg-zinc-800/40 border border-slate-200/70 dark:border-zinc-800 flex items-center justify-between gap-3 text-xs"
                  >
                    <div className="min-w-0 flex-1">
                      <p
                        className="font-bold text-slate-900 dark:text-zinc-100 truncate"
                        title={doc.documentName}
                      >
                        {doc.documentName}
                      </p>
                      <div className="flex items-center gap-2 mt-0.5 text-[11px] text-slate-400 dark:text-zinc-500 flex-wrap">
                    ...
                    <div className="shrink-0">
                      {doc.isVerified ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-slate-200 text-slate-700 dark:bg-zinc-700 dark:text-zinc-300">
