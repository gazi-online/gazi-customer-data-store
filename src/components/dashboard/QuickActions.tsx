  ...
  return (
    <section className="flex flex-col gap-2" aria-label="Quick Actions">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3.5">
        ...
        <Link
          href="/customers/new"
          className="bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-600 hover:from-violet-700 hover:via-indigo-700 hover:to-blue-700 active:scale-[0.99] text-white px-4 sm:px-5 min-h-[44px] h-11 sm:h-12 rounded-[14px] sm:rounded-[16px] flex items-center justify-center gap-2.5 shadow-[0_2px_8px_rgba(99,102,241,0.25)] transition-all group font-semibold text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
        ...
        <Link
          href="/customers/new"
          className="bg-white border border-slate-200 hover:border-violet-300 hover:bg-slate-50/70 active:scale-[0.99] px-4 sm:px-5 min-h-[44px] h-11 sm:h-12 rounded-[14px] sm:rounded-[16px] flex items-center justify-center gap-2.5 transition-all text-slate-800 font-semibold text-xs sm:text-sm shadow-[0_2px_6px_rgba(15,23,42,0.03)] focus:outline-none focus:ring-2 focus:ring-violet-500 group"
        >
